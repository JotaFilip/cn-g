...
\begin{itemize}[noitemsep]
  ...
  \item Lack of Cloud Security Architecture.
...
\end{itemize}
\fpar Content Delivery Networks (CDNs) can be used to perform attacks to the Cloud Storage or the service provided. So, as threats we have: Outages of provider. Internal threat due to misconfiguration or bad management of CDN. Malicious insider.
