...
\par In this paper is addressed the security threats to Cloud Storage and one of its uses as Content Delivery Network. A Content Delivery Network caches a copy of a resource in near user replicas having in mind demand.
