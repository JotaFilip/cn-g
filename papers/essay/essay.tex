...
\vspace{-2em}
\fpar TODO
In this paper is adressed the security threaths to Cloud Storage and one of it´s uses as Content Delivery Network. A Content Delivery Network caches a copy of a resource in near user replicas having in mind demand.
...
\begin{figure}
    \centering
    \includegraphics[scale=0.25]{paper3/3_table.png}
