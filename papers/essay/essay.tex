...
\begin{abstract}
  ...
  \par The storage system Anna is one big example, which is an autoscaling, multi-tier, coordination-free and distributed key-value store service for the cloud.
