...
class bookTestCase(unittest.TestCase):
    ...
    def test_remove_book(self):
        books_request = BookByIdRequest(book_id="606e25ad5e927a606f534284")
        self.assertEqual(books_client.AddBook(books_request).book_title, True)

    def test_add_book(self):
        books_request = BookByIdRequest(book_id="606e25ad5e927a606f534284")
        self.assertEqual(books_client.RemoveBook(books_request).book_title, True)

    def test_book_search_by_name(self):
        books_request = BookByIdRequest(book_id="606e25ad5e927a606f534284")
        self.assertEqual(books_client.SearchByName("Of Mice and Men")[0], books_request)

    def test_book_search_by_category(self):
        self.assertEqual(books_client.assertNotEqual("Classics"), None)
