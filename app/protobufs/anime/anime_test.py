...
class AnimeTestCase(unittest.TestCase):
    ...
    def test_add_anime(self):
        animes_request = AnimeData(anime_title="Testa", genres=["Teste"], anime_rating = 4.55, img_url="teste.jpg")
    ...
    def test_anime_search_by_category(self):
        self.assertNotEqual(animes_client.SearchByCategory("Action").animes.size, 0)
