...
\par After discovering the amount of money used on the Cloud SQL we shut it down and repopulated an independent database, hosted by a Raspberry Pi (with all the security measures).
