...
\par We created a local version of our application for several reasons: we were more familiar with the development of local-running applications, running the application on the cloud costs money, and we can debug the app better when it is running locally which is important during development. When developing a feature, first we would put everything running locally, by running a script, and once the feature was running without issues on our machines, we would adapt it to run on the cloud.
  ...
  \subsection{Server (Microservices)}
    ...
    \subsubsection{Suggestion Algorithm}
    \fpar This algorithm lives inside the Library Service.
    \fpar Since we are a recommendation API, we also implemented an algorithm to suggest what the User should see next.
    ...
    \par For this purpose, the algorithm uses a scoring mechanism that attributes each category 1 point for every view and 3 points for every like. Afterwords, the 3 categories with the highest score are chosen. \par The function will then recommend a random sample (every sample has the number of elements that were determined by the user) for each category.
...
\par To test our Spark implementation we used the interface inside the Google Cloud named Dataproc.
  ...
  \fpar We ran Locust, the tool to perform the load testing, in another cluster to avoid affecting the results. 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graf1.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graf2.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graf3.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graf4.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graf5.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graff1.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graff2.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graff3.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graff4.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/graff5.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/grafff1.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/grafff2.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/grafff3.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/grafff4.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/grafff5.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/locust1.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/locust2.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/locust3.png }
\end{figure}
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{ tests/locust4.png }
\end{figure}
\end{document}