  ...
  \label{sec:contributions}
    ...
    \subsubsection{51058 - Diogo Lopes}
      \begin{itemize}
        ...
        \item Initially, searched how Spark worked and how we could integrate it and use it in our application.
        \item Report.
      \end{itemize}
    ...
    \subsubsection{51111 - João Afonso}
        \begin{itemize}
        	...
        	\item Helped with Docker \& Kubernetes.
       		\item Software testing \& bug fixes (also added new functions to complement existing ones).
        	\item Helped with auth0.
        	\item Helped wiyh Spark.
        	\item Report.
      	\end{itemize}
